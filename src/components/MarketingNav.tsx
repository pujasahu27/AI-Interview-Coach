...
export function MarketingNav() {
  return (
    <nav className="fixed inset-x-0 top-0 z-50 flex h-[68px] items-center justify-between border-b border-line bg-background/70 px-4 backdrop-blur-md sm:pl-16 sm:pr-12">
